    ...
    <div class="layout student-sidebar-layout">
        ...
        <main class="main">
            <div class="page">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $frameworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <section class="framework-card">
                        <div class="framework-head">
                            <div>
                                <h2><?php echo e($framework->name); ?></h2>
                                <?php if($framework->description): ?><p class="framework-description"><?php echo e($framework->description); ?></p><?php endif; ?>
                            </div>
                            <span class="status <?php echo e($isMet ? 'met' : ''); ?>"><?php echo e($isMet ? 'Requirements Met' : 'In Progress'); ?></span>
                        </div>
                        <div class="meta">
                            <?php if($framework->pqf_level): ?><span>PQF <strong><?php echo e($framework->pqf_level); ?></strong></span><?php endif; ?>
                            <?php if($framework->target_recognition): ?><span>Target <strong><?php echo e($framework->target_recognition); ?></strong></span><?php endif; ?>
                            <span><strong><?php echo e($item['completed_required_count']); ?></strong> of <strong><?php echo e($item['target_required_count']); ?></strong> required target met</span><span><?php echo e($item['total_required_count']); ?> required configured</span>
                            <span><strong><?php echo e($item['remaining_required_count']); ?></strong> remaining</span>
                        </div>
                        <div class="progress-row" aria-label="<?php echo e($item['completion_percentage']); ?> percent complete">
                            <div class="track"><div class="fill" style="width:<?php echo e($item['completion_percentage']); ?>%"></div></div>
                            <div class="percent"><?php echo e($item['completion_percentage']); ?>%</div>
                        </div>

                        <?php if($item['can_request_recognition']): ?>
                            <form method="POST" action="<?php echo e(route('stacking.recognition.request', $framework->id)); ?>" style="margin-top:16px;">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php elseif($item['recognition'] ?? null): ?>
                            <div style="margin-top:14px;padding:10px 12px;border-radius:10px;background:#f8fafc;border:1px solid #e2e8f0;color:#344054;font-weight:700;">
                                Recognition status: <?php echo e(ucfirst(str_replace('_', ' ', $item['recognition']->status))); ?>
                        ...
                        <table class="requirements">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $item['requirements']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><span class="course-title"><?php echo e($detail['course']->title); ?></span></td>
                                        <td><?php echo e($framework->sequence_required ? $detail['requirement']->order : '—'); ?></td>
                                        <td><?php echo e($detail['is_required'] ? 'Required' : 'Optional'); ?></td>
                                        <td>
                                            <?php if($detail['is_completed']): ?>
                                                <span class="complete">Completed</span><br><small><?php echo e($detail['completed_at']?->format('M j, Y')); ?></small>
                                            <?php else: ?>
...
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/student/stacking-progress.blade.php ENDPATH**/ ?>
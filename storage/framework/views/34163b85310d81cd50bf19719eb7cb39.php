...
<body>
    ...
    <main class="page">
        <?php if(session('success')): ?>
            <div class="pill" style="display:block;background:#ecfdf3;border-color:#a7f3d0;color:#065f46;margin-bottom:16px;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        ...
        <section class="hero">
            ...
            <div class="hero-badges"><span class="pill"><strong><?php echo e($unreadCount); ?></strong>Unread</span><span class="pill"><strong><?php echo e($totalCount); ?></strong>Total</span></div>
        </section>

        <a href="<?php echo e(route($homeRoute)); ?>" class="btn-home"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M3 10.5L12 3l9 7.5"/><path d="M5 9.8V20h14V9.8"/></svg>Home</a>

        <div class="content-grid">
            <aside class="sidebar-card">
                <h3>Filter</h3>
                <a class="filter-item <?php echo e($active === 'all' ? 'active' : ''); ?>" href="<?php echo e(route('notifications.index')); ?>">All notifications <span class="count"><?php echo e($totalCount); ?></span></a>
                <a class="filter-item <?php echo e($active === 'unread' ? 'active' : ''); ?>" href="<?php echo e(route('notifications.index', ['filter' => 'unread'])); ?>">Unread <span class="count"><?php echo e($unreadCount); ?></span></a>
                <a class="filter-item <?php echo e($active === 'course' ? 'active' : ''); ?>" href="<?php echo e(route('notifications.index', ['filter' => 'course'])); ?>">Courses <span class="count"><?php echo e($all->where('type', 'course')->count()); ?></span></a>
                <a class="filter-item <?php echo e($active === 'announcement' ? 'active' : ''); ?>" href="<?php echo e(route('notifications.index', ['filter' => 'announcement'])); ?>">Announcements <span class="count"><?php echo e($all->where('type', 'announcement')->count()); ?></span></a>
                <a class="filter-item <?php echo e($active === 'system' ? 'active' : ''); ?>" href="<?php echo e(route('notifications.index', ['filter' => 'system'])); ?>">System <span class="count"><?php echo e($all->where('type', 'system')->count()); ?></span></a>
            </aside>

            <section class="list-card">
            <div class="list-card-head"><h3>Recent updates</h3>
                <?php if(auth()->guard()->check()): ?>
                    <form method="POST" action="<?php echo e(route('notifications.readAll')); ?>"><?php echo csrf_field(); ?><button type="submit" <?php if($unreadCount === 0): echo 'disabled'; endif; ?>>Mark all as read</button></form>
                <?php endif; ?>
            </div>
            <?php $__empty_1 = true; $__currentLoopData = $visible; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="notif-item <?php echo e($notification->unread ? 'unread' : ''); ?>">
                    ...
                    <div style="flex:1;min-width:0;"><div class="notif-title"><strong><?php echo e($notification->title); ?></strong><?php if($notification->unread): ?><span class="unread-dot" aria-hidden="true"></span><?php endif; ?></div><div style="color:#4b5563;font-size:14px;line-height:1.5;"><?php echo e($notification->message); ?></div><div class="notif-meta"><?php echo e($notification->time); ?> · <?php echo e(ucfirst($notification->type)); ?></div></div>
                    <?php if(!empty($notification->url)): ?><a href="<?php echo e($notification->url); ?>" class="notif-action">View</a><?php endif; ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div style="padding:34px 8px;text-align:center;color:var(--muted);font-size:14px;"><?php echo e($active === 'unread' ? "You're all caught up — nothing unread." : 'Nothing to show in this filter.'); ?></div>
            <?php endif; ?>
            </section>
        </div>
    </main>
...
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/public/notifications.blade.php ENDPATH**/ ?>
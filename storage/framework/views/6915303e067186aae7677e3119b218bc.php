...
<title><?php echo e(($editing ?? false) ? 'Edit Course' : 'Create Courses'); ?> | Upskill</title>
...
<div class="layout faculty-sidebar-layout">
    ...
    <div class="build-shell">
            <div class="build-form">
                <?php if(($editing ?? false) && ($course ?? null)): ?>
        ...
        <div class="page-head">
            <div class="page-head__row">
                <div>
                    <h2><?php echo e(($editing ?? false) ? 'Edit Course' : 'Create New Course'); ?></h2>
                    <p><?php echo e(($editing ?? false)
        ...
        <?php $isEdit = ($editing ?? false) && ($course ?? null); ?>

        <form method="POST"
              action="<?php echo e($isEdit ? route('faculty.courses.update', $course->id) : route('faculty.create.store')); ?>"
        ...
        <section class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field">
                    ...
                    <input class="input" type="text" name="title" id="courseTitleInput" placeholder="e.g. Introduction to Web Development" value="<?php echo e(old('title', $course->title ?? '')); ?>" required>
                </div>
                ...
                <div class="field field-grid">
                        ...
                        <div class="select-wrap">
                            <select class="select" name="category">
                                ...
                                <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category); ?>" <?php if(old('category', $course->category ?? '') === $category): echo 'selected'; endif; ?>><?php echo e($category); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="hidden" name="related_skills_csv" id="relatedCsv"
                               value="<?php echo e(implode('||', $relatedSaved)); ?>">

                        <?php if(($editing ?? false) && empty($relatedSaved)): ?>
                        ...
                        <div class="related-wrap" id="relatedWrap">
                            <button type="button" class="related-mini <?php echo e(count($relatedSaved) ? 'has-value' : ''); ?>"
                                    id="relatedMini" onclick="openRelated()">
                                <span id="relatedMiniLabel">
                                    <?php echo e(count($relatedSaved) ? count($relatedSaved) . ' selected' : 'None'); ?>
                            ...
                            <div class="related-pop" id="relatedPop" hidden role="dialog"
                                ...
                                <div class="related-search">
                                    ...
                                    <input type="text" id="relatedSearch" autocomplete="off"
                                           placeholder="Search <?php echo e(count($skillList)); ?> skills..."
                                ...
                                <div class="related-list" id="relatedList">
                                    <?php $__currentLoopData = ($skillGroups ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $groupSkills): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="related-group" data-group="<?php echo e($groupName); ?>">
                                            <div class="related-group-hd"><?php echo e($groupName); ?></div>
                                            <?php $__currentLoopData = $groupSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="related-opt <?php echo e(in_array($skill, $relatedSaved) ? 'on' : ''); ?>"
                        ...
                        <?php if(count($relatedSaved)): ?>
                            <div class="related-chips" id="relatedChips">
                                <?php $__currentLoopData = $relatedSaved; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="related-chip"><?php echo e($skill); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="field field-grid">
                    <div>
                        ...
                        <div class="competency-list" id="competencyList">
                            <?php $__currentLoopData = $savedCompetencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="competency-chip"><input type="hidden" name="competencies[]" value="<?php echo e($competency); ?>"><span><?php echo e($competency); ?></span><button type="button" class="competency-remove" aria-label="Remove <?php echo e($competency); ?>">&times;</button></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="select-wrap">
                            <select class="select" name="pqf_level">
                                ...
                                <?php $__currentLoopData = [5,6,7,8]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pqfLevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pqfLevel); ?>" <?php if((string) old('pqf_level', $course->pqf_level ?? '') === (string) $pqfLevel): echo 'selected'; endif; ?>>PQF Level <?php echo e($pqfLevel); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="select-wrap">
                            <select class="select" name="level">
                                <?php $__currentLoopData = $levels ?? ['Beginner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($level); ?>" <?php if(old('level', $course->level ?? 'Beginner') === $level): echo 'selected'; endif; ?>><?php echo e($level); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="field">
                    ...
                    <?php echo $__env->make('components.rich-text-editor', ['name' => 'description', 'id' => 'course-description-editor', 'value' => old('description', $course->description ?? ''), 'placeholder' => 'Describe the micro-credential, its purpose, and what learners will achieve.'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                <div class="field field-grid">
                    <div>
                        <label>Duration (Hours)</label>
                        <input class="input" type="number" name="duration" placeholder="0" min="0" value="<?php echo e(old('duration', isset($course) && $course ? (float) rtrim($course->duration ?? '', 'h') : '')); ?>">
                    </div>
                    <div>
                        <label>Passing Score</label>
                        <input class="input" type="number" name="passing_score" placeholder="75" min="0" max="100" value="<?php echo e(old('passing_score', $course->passing_score ?? '')); ?>">
                    </div>
                </div>
        ...
        <section class="form-card">
            ...
            <div class="form-card-body">
                ...
                <?php if(($editing ?? false) && ($course->thumbnail_url ?? null)): ?>
                    <div class="thumb-current">
                        Current thumbnail: <strong><?php echo e(basename($course->thumbnail_url)); ?></strong>
        ...
        <section class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field">
                    ...
                    <textarea class="textarea" name="learning_objectives"><?php echo e(old('learning_objectives', isset($course) && $course ? implode("\n", $course->objectives ?? []) : '')); ?></textarea>
                </div>
                ...
                <div class="field">
                    ...
                    <?php if(($prereqOptions ?? collect())->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div id="prereq-list"
                            ...
                            <?php $__currentLoopData = $prereqOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="prereq-item"
                                       data-name="<?php echo e(strtolower($opt->title . ' ' . $opt->category)); ?>"
                                       style="display:flex;align-items:center;gap:10px;padding:9px 10px;
                                              border-radius:8px;cursor:pointer;font-size:13.5px;">
                                    <input type="checkbox" name="prerequisite_ids[]" value="<?php echo e($opt->id); ?>"
                                           style="width:16px;height:16px;accent-color:#13176b;"
                                           <?php if(in_array($opt->id, $selectedPrereqs, true)): echo 'checked'; endif; ?>>
                                    <span style="font-weight:700;"><?php echo e($opt->title); ?></span>
                                    <?php if($opt->category): ?>
                                        <span style="color:#6b7280;font-size:12px;"> - <?php echo e($opt->category); ?></span>
                                    <?php endif; ?>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
        ...
        <section class="form-card">
            ...
            <div class="form-card-body">
                <?php echo $__env->make('components.inline-badge-builder', ['course' => $course ?? null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="form-card-body">
                <div class="field">
                    <label style="display:inline-flex;align-items:center;gap:10px;cursor:pointer;">
                        ...
                        <input type="checkbox" name="requires_faculty_verification" value="1" style="width:16px;height:16px;accent-color:#13176b;" <?php if(old('requires_faculty_verification', $course->requires_faculty_verification ?? false)): echo 'checked'; endif; ?>>
            ...
            <div class="form-card-body">
                <div class="settings-row">
                    ...
                    <label class="radio-item">
                        <input type="radio" name="status" value="draft" <?php if(old('status', ($course->approval_status ?? '') === 'draft' ? 'draft' : 'submit') === 'draft'): echo 'checked'; endif; ?>>
                        <span class="radio-dot"></span>
                        Draft
                    </label>

                    <label class="radio-item">
                        <input type="radio" name="status" value="submit" <?php if(old('status', ($course->approval_status ?? '') === 'draft' ? 'draft' : 'submit') === 'submit'): echo 'checked'; endif; ?>>
                        <span class="radio-dot"></span>
                        Submit for approval
                    </label>
                </div>
                ...
                <?php if($editing ?? false): ?>
                    ...
                    <div class="field" style="margin-top:18px;">
                        ...
                        <textarea class="textarea" name="change_note" rows="4"
                                  placeholder="e.g. Rewrote Module 2 lessons and lowered the passing score to 70%."><?php echo e(old('change_note', $course->change_note ?? '')); ?></textarea>
                    </div>
                <?php endif; ?>
            </div>
        </section>
        ...
        <div class="form-actions">
            <button class="btn-save" type="submit"><?php echo e(($editing ?? false) ? 'Save Changes' : 'Save'); ?></button>
            <a href="<?php echo e(($editing ?? false) && ($course ?? null)
...
<script>
    ...
    (function () {
        ...
        var IS_EDIT = <?php echo e(($editing ?? false) ? 'true' : 'false'); ?>;
        if (IS_EDIT) return;
        ...
        try {
            ...
            var hasServerValues = <?php echo e($errors->any() ? 'true' : 'false'); ?>;
            if (!hasServerValues) {
...
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/faculty/courses/create.blade.php ENDPATH**/ ?>
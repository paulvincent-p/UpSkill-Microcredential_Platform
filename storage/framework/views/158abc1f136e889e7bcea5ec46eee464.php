...
<div class="layout">
    ...
    <aside class="course-nav">
        <div class="course-nav-header">
            <?php if($course->category ?? false): ?><div class="nav-category"><?php echo e($course->category); ?></div><?php endif; ?>
            <div class="nav-title"><?php echo e($course->title ?? 'Course'); ?></div>
        ...
        <div class="modules-scroll">
            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mIndex => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="module-group <?php echo e($mIndex > 0 ? 'module-locked' : ''); ?>" id="mg-<?php echo e($mIndex); ?>">

                <div class="module-toggle">
                    <div class="module-title-area" id="mta-<?php echo e($mIndex); ?>"
                         onclick="showModuleWelcome(<?php echo \Illuminate\Support\Js::from($module->title)->toHtml() ?>,<?php echo e($module->lessons->count()); ?>,<?php echo e($modules->count()); ?>,<?php echo e($badge_count ?? 1); ?>,<?php echo e($mIndex); ?>,<?php echo \Illuminate\Support\Js::from($module->description ?? '')->toHtml() ?>)">
                        <span class="module-num">Module <?php echo e($mIndex + 1); ?>: <?php echo e($module->title); ?></span>
                        <span class="module-sub" id="msub-<?php echo e($mIndex); ?>"><?php echo e($module->lessons->count()); ?> lessons</span>
                        <?php if($mIndex > 0): ?>
                        <span class="module-lock-badge" id="mlock-<?php echo e($mIndex); ?>">
                            Complete previous quiz to unlock
                        </span>
                        <?php endif; ?>
                    </div>
                    <button class="module-chevron-btn" type="button"
                            onclick="toggleModule('mod-<?php echo e($mIndex); ?>','chev-<?php echo e($mIndex); ?>')">
                        <svg class="chevron <?php echo e($mIndex===0?'open':''); ?>" id="chev-<?php echo e($mIndex); ?>"
                ...
                <div class="lesson-list <?php echo e($mIndex===0?'open':''); ?>" id="mod-<?php echo e($mIndex); ?>">
                    <?php $__currentLoopData = $module->lessons ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lIndex => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $isVid = strtolower($lesson->type??'')  === 'video'; ?>
                        <div class="lesson-item"
                             id="li-<?php echo e($mIndex); ?>-<?php echo e($lIndex); ?>"
                             data-module="<?php echo e($mIndex); ?>"
                             data-lid="<?php echo e($lesson->id); ?>"
                             onclick="loadLesson(
                                 <?php echo \Illuminate\Support\Js::from($lesson->type ?? 'Text')->toHtml() ?>,
                                 <?php echo \Illuminate\Support\Js::from($lesson->title)->toHtml() ?>,
                                 <?php echo \Illuminate\Support\Js::from($lesson->description ?? $lesson->title)->toHtml() ?>,
                                 <?php echo \Illuminate\Support\Js::from($lesson->duration ?? '15m')->toHtml() ?>,
                                 <?php echo e($mIndex); ?>, <?php echo e($lIndex); ?>,
                                 <?php echo \Illuminate\Support\Js::from($lesson->content ?? $lesson->description ?? '')->toHtml() ?>
                             )">
                            <span class="lesson-title-text"><?php echo e($lesson->title); ?></span>
                            <span class="lesson-meta"><?php echo e($lesson->type); ?> - <?php echo e($lesson->duration); ?></span>
                            <span class="status-dot"></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <?php if($module->quiz ?? false): ?>
                    <div class="quiz-row">
                        <div>
                            <div class="quiz-info-title"><?php echo e($module->quiz->title); ?></div>
                            <div class="quiz-info-sub">
                                <?php echo e($module->quiz->questions_count ?? 3); ?> questions -
                                Pass <?php echo e($module->quiz->passing_score ?? 75); ?>%
                                <?php if(($module->quiz->time_limit ?? 0) > 0): ?>
                                    - <?php echo e($module->quiz->time_limit); ?> min
                                <?php else: ?>
                                    - No time limit
                                <?php endif; ?>
                            </div>
                        ...
                        <button class="btn-quiz-sm locked" id="qbtn-<?php echo e($mIndex); ?>"
                                data-module="<?php echo e($mIndex); ?>"
                                onclick="handleQuizClick(<?php echo e($mIndex); ?>)"
    ...
    <main class="lesson-content lesson-content lesson-rich-content">
        ...
        <div id="view-welcome">
            ...
            <div class="welcome-hero">
                ...
                <h1 class="welcome-hero-title" id="wh-mod-title"><?php echo e($modules->first()->title ?? 'the Course'); ?></h1>
            ...
            <div class="welcome-stats-strip">
                <div class="wss-item">
                    <span class="wss-num" id="ws-mod"><?php echo e($modules->count()); ?></span>
                    <span class="wss-lbl">Modules</span>
                </div>
                <div class="wss-item">
                    <span class="wss-num" id="ws-les"><?php echo e($total_lessons ?? 0); ?></span>
                    <span class="wss-lbl">Lessons</span>
                </div>
                <div class="wss-item">
                    <span class="wss-num" id="ws-bdg"><?php echo e($badge_count ?? 1); ?></span>
...
var MODULE_DESCRIPTIONS = <?php echo $modules->mapWithKeys(fn ($m, $i) => [
    $i => (string) ($m->description ?? ''),
])->toJson(JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>;

var QUIZ_DATA = <?php echo $modules->mapWithKeys(fn ($m, $i) => [
    $i => [
        'title'        => $m->quiz->title ?? '',
...
var _savedProgress = <?php echo json_encode($saved_progress ?? ['completed_lessons' => [], 'module_scores' => new \stdClass()]); ?>;
var _serverUnlocks = <?php echo json_encode($quiz_unlocks ?? new \stdClass()); ?>;   // moduleIdx â†’ retake unlock timestamp (ms), from the server
var _serverUnlocksAuthoritative = true;   // this list is complete: anything absent from it is unlocked
var _quizAttempts = <?php echo json_encode($quiz_attempts ?? new \stdClass()); ?>;   // moduleIdx â†’ {allowed, used, remaining, exhausted}
...
function saveProgress(immediate) {
    ...
    var _run = function () {
        ...
        return fetch('<?php echo e(route('courses.progress', $course->id)); ?>', {
            method: 'POST',
            headers: {
...
window.addEventListener('pagehide', function () {
    ...
    try {
        navigator.sendBeacon(
            '<?php echo e(route('courses.progress', $course->id)); ?>',
...
function quizDeadlineKey(modIdx) {
    return 'upskill_quiz_deadline_c<?php echo e($course->id); ?>_m' + modIdx;
}
...
const RETAKE_KEY_PREFIX  = 'quizRetakeUnlockAt_<?php echo e($course->id ?? ($course->title ?? "course")); ?>_';
...
function retakeQuiz() {
    ...
    fetch('<?php echo e(route('courses.progress', $course->id)); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Accept': 'application/json',
...
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/student/courses/enrollment.blade.php ENDPATH**/ ?>
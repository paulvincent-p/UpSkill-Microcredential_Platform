...
<table class="meta-table">
    <tr>
        <td>
            <?php if($preparedName !== ''): ?>
                Prepared by: <strong><?php echo e($preparedName); ?></strong> (Faculty)
            <?php endif; ?>
        </td>
        <td class="right">
            Generated: <strong><?php echo e(($generatedAt ?? now())->format('F j, Y — g:i A')); ?></strong>
        </td>
    </tr>
</table>
...
<table class="stat-table">
    <tr>
        <td class="stat-cell navy">
            <span class="num"><?php echo e($onlineNow ?? 0); ?></span>
                ...
                <tbody>
                    <?php $__currentLoopData = $points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="bar-track">
                                    <div class="bar-fill <?php echo e($isPeak ? 'peak' : ''); ?>" style="width: <?php echo e($width); ?>%;"></div>
                                </div>
                            </td>
                            <td class="num"><strong><?php echo e($value); ?></strong></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
            <p class="stat-note">Gold bar marks the peak period (<?php echo e($peakValue); ?>).</p>
        <?php else: ?>
    ...
    <div class="section-body">
        <?php if($success->isNotEmpty()): ?>
            <table class="data-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $success->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr>
                            <td>
                                <span class="dot" style="background-color: <?php echo e($donutColors[$i % count($donutColors)]); ?>;"></span>
                                <?php echo e($segment['label'] ?? ''); ?>

                            </td>
                            <td class="num"><strong><?php echo e($count); ?></strong></td>
                            <td class="num"><?php echo e($share); ?>%</td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><strong>Total</strong></td>
                        <td class="num"><strong><?php echo e($success->sum('count')); ?></strong></td>
                        <td class="num">100%</td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="section-body">
        <?php if(!empty($recentActivity)): ?>
            <table class="data-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="activity-title"><?php echo e($event['title']); ?></td>
                            <td class="activity-detail"><?php echo e($event['detail']); ?></td>
                            <td class="activity-time"><?php echo e($event['time']); ?><br><?php echo e($event['date']); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
...
<table class="meta-table report-footer">
    <tr>
        ...
        <td class="right">Page generated <?php echo e(($generatedAt ?? now())->format('Y-m-d H:i')); ?></td>
    </tr>
</table>

</body>
</html>
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/faculty/analytics-report-pdf.blade.php ENDPATH**/ ?>
...
<aside class="student-sidebar" id="student-sidebar">
    ...
    <a href="<?php echo e(route('courses.enrolled')); ?>" class="side-link <?php echo e(request()->routeIs('courses.enrolled') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('stacking.progress')); ?>" class="side-link <?php echo e(request()->routeIs('stacking.*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/components/student-sidebar.blade.php ENDPATH**/ ?>
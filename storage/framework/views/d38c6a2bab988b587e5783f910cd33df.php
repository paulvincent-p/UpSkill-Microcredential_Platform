    ...
    <main class="main">
        ...
        <form action="<?php echo e(route('courses.browse')); ?>" method="GET" class="filters-bar">
            ...
            <input type="hidden" name="recommended" id="recommendedInput"
                   value="<?php echo e(!empty($filters['recommended']) ? 1 : 0); ?>">
            <button type="button" id="btnRecommended"
                    class="btn-recommended <?php echo e(!empty($filters['recommended']) ? 'is-on' : ''); ?>"
                    aria-pressed="<?php echo e(!empty($filters['recommended']) ? 'true' : 'false'); ?>"
        ...
        <div class="courses-grid">
            <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('courses.show', $course->id)); ?>" class="browse-card">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <?php if($descPreview !== ''): ?>
                            <p class="desc"><?php echo e($descPreview); ?></p>
                        <?php endif; ?>
                        <div class="meta">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="empty-state">
                    <?php if(!empty($filters['recommended'])): ?>
...
<?php /**PATH C:\Users\PaulV\Documents\MICROCREDENTIALS NEW ADDITIONS\UPSKILL - Microcredential Platform\resources\views/student/courses/browse.blade.php ENDPATH**/ ?>
<footer class="footer">
    <div class="container footer__grid">
        ...
        <div class="footer__brand-col">
            <a href="{{ url('/') }}" class="footer__brand">
                
                <span>UPSKILL</span>
            </a>
            <p class="footer__tagline">The Official Platform for PSU Microcredentials</p>
            <p class="footer__copy">&copy; {{ date('Y') }} Pangasinan State University. All rights reserved.</p>
        </div>

        <div class="footer__col">
            <h4 class="footer__heading">Platform</h4>
            <ul class="footer__list">
                <li><a href="{{ url('/explore') }}">Explore Courses</a></li>
                <li><a href="{{ url('/microcredentials') }}">Microcredentials</a></li>
        ...
        <div class="footer__col">
            ...
            <ul class="footer__list">
                ...
                <li><a href="{{ url('/register') }}">Enroll Now</a></li>
            </ul>
        </div>

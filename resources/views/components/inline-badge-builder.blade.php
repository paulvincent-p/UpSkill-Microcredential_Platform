    ...
    <div class="badge-settings">
        ...
        <div id="inlineBadgeFields" class="badge-fields" @style(['display:none' => !$enabled])>
                ...
                <div class="field">
                    ...
                    <select class="select" name="badge_level" id="inlineBadgeLevel">
                        @foreach(['Bronze','Silver','Gold','Platinum'] as $lvl)
                            <option value="{{ $lvl }}" @selected($badgeLevel === $lvl)>{{ $lvl }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="field">
                ...
                <textarea class="textarea" name="badge_description" id="inlineBadgeDescription" maxlength="400" rows="3" placeholder="Briefly describe what earning this badge represents.">{{ $badgeDescription }}</textarea>
            </div>

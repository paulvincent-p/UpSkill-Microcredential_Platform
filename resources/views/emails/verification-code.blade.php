...
<body style="margin:0; padding:0; background-color:#f4f5fb;">
    {{--
        Email HTML is not web HTML: most clients (Gmail, Outlook) strip
        <style> blocks and external CSS, so everything below is tables and
        inline styles. No <img> logo either — a logo hosted on localhost
        renders broken for every recipient, so the brand is plain text.
    --}}
                    ...
                    <tr>
                        <td style="padding:32px 32px 8px; font-family:Arial,Helvetica,sans-serif; color:#2a2f4a;">
                            ...
                            <p style="font-size:14px; line-height:1.6; margin:0 0 20px;">
                                Hi {{ $toName }}, we received a request to reset the password on your
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="background-color:#f4f5fb; border:2px dashed #1b2350; border-radius:10px; padding:20px;">
                                        <span style="font-family:'Courier New',Courier,monospace; font-size:34px; font-weight:bold; letter-spacing:10px; color:#1b2350;">{{ $code }}</span>
                                    </td>
                                </tr>
                            </table>

                            <p style="font-size:13px; line-height:1.6; margin:20px 0 0; color:#6a7194;">
                                This code expires in <strong>{{ $ttlMinutes }} minutes</strong> and can be

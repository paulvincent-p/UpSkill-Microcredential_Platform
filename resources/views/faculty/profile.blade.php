{{--
    ...
    Faculty â€º My Profile â€” single self-contained Blade view (no layout file).
    Combines TWO designs into one page, restyled to the Upskill theme:

      â‘  Profile card + About me + Settings   (reference image 1)
      â‘¡ Performance / Activity charts + Courses table (reference image 2)

    âš  STANDALONE: the ONLY connections on this page are:
        â€¢ Sidebar  Dashboard      â†’ route('faculty.dashboard')
        â€¢ Sidebar  My Courses     â†’ route('faculty.courses')
        â€¢ Sidebar  Create Courses â†’ route('faculty.create')
        â€¢ Topbar   Courses pill   â†’ route('faculty.courses')
        â€¢ Topbar   Dashboard pill â†’ route('faculty.dashboard')
...
<div class="layout faculty-sidebar-layout">
    ...
    {{-- Sidebar â€” Dashboard, My Courses & Create Courses connected; Profile is this page --}}
    ...
    <main class="main">
        ...
        <div class="page-head">
            ...
            <div class="page-actions">
                ...
                {{-- âœ… Functioning â€” opens the Edit Profile drawer --}}
        ...
        {{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â• â‘  ABOUT ME + SETTINGS â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
        <div class="two-col">
            ...
            <section class="panel" style="margin-bottom:28px;">
                ...
                <div class="panel-body">
                    <div class="set-row">
                        ...
                        {{-- âœ… Functioning â€” opens the drawer on Account Settings --}}
                    ...
                    <div class="set-row">
                        ...
                        {{-- âœ… Functioning â€” opens the drawer where the choice is saved --}}
...
<div id="editModal" class="modal-overlay" onclick="handleOverlayClick(event)">
    <div class="modal-panel" role="dialog" aria-modal="true" aria-label="Edit Profile">
        ...
        {{-- âœ… Functioning â€” saves the whole profile via faculty.profile.update --}}
